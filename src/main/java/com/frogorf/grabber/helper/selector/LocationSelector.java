...
public final class LocationSelector {
    ...
    public static int COUNTRY_D_ID = 5;
    public static int REGION_D_ID = 6;
    public static int DISTRICT_D_ID = 7;
    public static int CITY_D_ID = 8;
    public static int CITY_AREA_D_ID = 9;
    public static int CITY_DISTRICT_D_ID = 10;
    public static int STREET_D_ID = 11;

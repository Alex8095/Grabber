...
public final class LocationSelector {
    ...
    public final static int HOUSE_NUMBER = 7;

    public final static int COUNTRY_D_ID = 1;
    public final static int REGION_D_ID = 2;
    public final static int DISTRICT_D_ID = 3;
    public final static int CITY_D_ID = 4;
    public final static int CITY_AREA_D_ID = 5;
    public final static int CITY_DISTRICT_D_ID = 6;
    public final static int STREET_D_ID = 7;
}
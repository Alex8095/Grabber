...
public final class OlxSelector {
    ...
    public final static String LOCATION = ".address .block";
    ...
    public final static String DATE_PUBLISHING = ".offercontentinner .lheight22 .brlefte5";
    public final static String SELLER = ".userdetails .xx-large";
    public final static String SELLER_LINK = ".userdetails .block .link";
    ...
    public final static String[] PHONE_CLEANER = new String[]{" ", "-", "(", ")", "+3"};
}

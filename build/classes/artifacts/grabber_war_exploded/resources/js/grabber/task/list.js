$(function () {
        ...
        dataSource: {
            ...
            transport: {
                ...
                read: {
                    ...
                    type: "POST",
                    url: frogorf.host + "/admin/grabber/task/grid"
                }
            },
            pageSize: 20.0
        },
    ...
    $("#ownerType").kendoDropDownList({
        ...
        dataSource: {
            transport: {
                read: frogorf.host + "/admin/dictionary/value/json?code=OWNER"
            }
        },
        change: ownerChange
    });
    ...
    $("#implementationType").kendoDropDownList({
        ...
        dataSource: {
            transport: {
                read: frogorf.host + "/admin/dictionary/value/json?code=IMPLEMENTATION"
            }
        },
